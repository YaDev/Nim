...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557550 = false;
    F.line = 31;
    var item_33557551 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557550 = item_33557551 !== undefined
    if (tmp_33557550) {
    F.line = 34;
    result_33557549 = nimCopy(null, makeNimstrLit(item_33557551.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557549 = nimCopy(null, (HEX24__systemZdollars_u8(e_p0) || []).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41] || []), NTI33554449);
    }
...
function HEX3Aanonymous__jsfetch95examples9549_u383(err_p0) {
  ...
  BeforeRet: {
    F.line = 119;
    F.filename = "jsfetch.nim";
    (await catch__jsfetch95examples9549_u386(then__jsfetch95examples9549_u360(then__jsfetch95examples9549_u319(fetch("https://api.github.com/users/torvalds"), HEX3Aanonymous__jsfetch95examples9549_u300, null), HEX3Aanonymous__jsfetch95examples9549_u357, null), HEX3Aanonymous__jsfetch95examples9549_u383));
    F.line = 119;
...
Label4: {
  F.line = 119;
  var _ = example__jsfetch95examples9549_u202();
};
Label5: {
  F.line = 119;
  var _ = example2__jsfetch95examples9549_u270();
};
}
