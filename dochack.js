    ...
    Label1: {
      ...
      Label2: {
          ...
          if (!(i_536872099 < L_536872100)) break Label3;
            ...
            pragmaDots_536870975.onclick = HEX3Aanonymous__dochack_u64;
            i_536872099 += 1;
...
function HEX5BHEX5D__pureZstrutils_u1263(s_p0, x_p1) {
  var result_704644340 = [];

    var a_704644342 = x_p1.a;
    var L_704644344 = addInt(subInt(subInt((s_p0).length, x_p1.b), a_704644342), 1);
    result_704644340 = nimCopy(null, mnewString(chckRange(L_704644344, 0, 2147483647)), NTI33554449);
    Label1: {
      var i_704644349 = 0;
      var i_536872168 = 0;
      Label2: {
          Label3: while (true) {
          if (!(i_536872168 < L_704644344)) break Label3;
            i_704644349 = i_536872168;
            result_704644340[chckIndx(i_704644349, 0, (result_704644340).length - 1)] = s_p0[chckIndx(addInt(i_704644349, a_704644342), 0, (s_p0).length - 1)];
            i_536872168 = addInt(i_536872168, 1);
          }
      };
    };

  return result_704644340;
...
async function loadIndex__dochack_u923() {
  ...
  BeforeRet: {
    ...
    var rootURL_536871868 = HEX5BHEX5D__pureZstrutils_u1263(cstrToNimstr(indexURL_536871843), HEX2EHEX2E__stdZenumutils_u103(0, 14));
...
function HEX3Aanonymous__dochack_u778(a_p0, b_p1) {
  ...
  BeforeRet: {
    ...
    matches_536871673.sort(HEX3Aanonymous__dochack_u778);
    Label5: {
      var i_536871720 = 0;
...
function wrapper__dochack_u1084() {
    ...
    var _ = then__dochack_u1099(loadIndexFut_536871994[0], wrapper__dochack_u1084, null);
    }
    ...
    timer_536871992[0] = setTimeout(wrapper__dochack_u1084, 400);
